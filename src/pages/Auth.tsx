      ...
      <main className="relative z-10 flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm rounded-[24px] border border-border/60 bg-card p-8 shadow-sm">
          ...
          <div className="mt-8 flex flex-col gap-2.5">
            ...
            <Button onClick={handleGitHub} disabled={loading} variant="outline" className="w-full h-11 rounded-xl bg-background hover:bg-muted/30 border-border/60 font-mono text-xs font-semibold gap-2 text-foreground transition-colors">
