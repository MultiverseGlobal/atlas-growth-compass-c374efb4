...
export default function HqShell() {
  ...
  return (
    <div className="min-h-screen atlas-grid-bg text-foreground flex flex-col overflow-x-hidden relative">
      ...
      <header className="absolute top-0 left-0 z-40 w-full h-14 px-4 md:px-6 flex items-center justify-between gap-4 transition-colors duration-300 bg-transparent pt-2">
